...
class Target_sparc : public Sized_target<size, big_endian>
{
 public:
  ...
  // Enumerate the relocations to look for symbol adjustments.
  void
 ...
 private:
  ...
  public:
    ...
    inline void
    enumerate(Symbol_table* symtab, Layout* layout, Target_sparc* target,
	   Sized_relobj_file<size, big_endian>* object,
	   unsigned int data_shndx,
	   Output_section* output_section,
	   const elfcpp::Rela<size, big_endian>& reloc, unsigned int r_type,
...
template<int size, bool big_endian>
inline void
Target_sparc<size, big_endian>::Scan::enumerate(
				Symbol_table* symtab,
				Layout* layout,
				Target_sparc<size, big_endian>* target,
				Sized_relobj_file<size, big_endian>* object,
...
template<int size, bool big_endian>
void
Target_sparc<size, big_endian>::enum_relocs(
			Symbol_table* symtab,
			Layout* layout,
			Sized_relobj_file<size, big_endian>* object,
			unsigned int data_shndx,
			...
			const unsigned char* plocal_symbols)
{
  ...
  gold::enum_relocs<size, big_endian, Sparc, elfcpp::SHT_RELA, Scan>(
    symtab,
    layout,
    this,
    object,
